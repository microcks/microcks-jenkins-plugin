 ...
 * @author laurent
 */
public class MicrocksImporterExecution extends AbstractSynchronousNonBlockingStepExecution<Void> {
   ...
   @Inject
   private transient MicrocksImporter step;

   @Override
   protected Void run() throws Exception {
      boolean success = step.doItCore(listener, filePath, runObj, null, launcher);
      if (!success) {
